...
const updateIntoDB = async (
  ...
  return await prisma.$transaction(async (tnx) => {
    ...
    // Doctor  (use Includes)-> doctorSpecialties  (use includes)-> specialties
...
const getAISuggestions = async (payload: { symptoms: string }) => {
  ...
  // A patient describes the following symptoms: "${payload.symptoms}".
  // Here is a list of doctors and their specialties:
  ...
  // From this list, suggest the 3 most relevant doctors to treat the patient.
